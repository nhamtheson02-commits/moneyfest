  ...
  return (
    <PageShell>
      <HeroSection
        ...
        image="/images/moneyfest/community/community-hero-ai.png"
      ...
      <RevealOnScroll as="section" id="channels" className="mf-dark-section py-14">
      ...
      <RevealOnScroll as="section" className="mf-dark-section py-10 mf-soft-divider">
        <div className="mf-container">
      ...
      <RevealOnScroll as="section" id="how" className="mf-dark-section py-12">
        <div className="mf-container">
      ...
      <RevealOnScroll as="section" className="mf-dark-section py-12">
        <div className="mf-container">
